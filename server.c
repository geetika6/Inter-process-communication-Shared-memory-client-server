...
void  main(int  argc, char *argv[])
{
     ...
     ShmKEY = ftok(".", 'x');
//to create shared memory first thing is to get the id , to which a random number is used as input
     ...
     printf("Shared mem add= %d\n",ShmID);
//this attaches the shared memory to the current process context     
     ...
     printf("Shared mem add attached= %p\n",ShmPTR);
